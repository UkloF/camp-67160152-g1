...
@section('content')
    ...
    <form action="{{ url('/pokedexs/'.$pokedex_update->id) }}" method="post">
        ...
        <input class="form-control" type="number" step="any" name="hp" id="hp" value="{{$pokedex_update->hp}}">

        <lable for="attack">Attack</lable>
        <input class="form-control" type="number" step="any" name="attack" id="attack" value="{{$pokedex_update->attack}}">

        <lable for="defense">Defense</lable>
        <input class="form-control" type="number" step="any" name="defense" id="defense" value="{{$pokedex_update->defense}}">
